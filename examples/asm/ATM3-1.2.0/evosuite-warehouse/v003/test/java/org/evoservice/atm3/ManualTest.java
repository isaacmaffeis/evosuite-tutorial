...
public class ManualTest {
  ...
  public void test00()  throws Throwable  {
    ...
    aTM3v2_0.set_selectedService(Service.WITHDRAWAL);
    aTM3v2_0.step();
    assertEquals(1000, aTM3v2_0.get_moneyLeft());
    assertEquals(State.CHOOSEAMOUNT, aTM3v2_0.get_atmState());
    assertEquals(0, aTM3v2_0.get_numOfBalanceChecks());

    aTM3v2_0.set_standardOrOther(MoneySizeSelection.STANDARD);
    aTM3v2_0.step();
    assertEquals(1000, aTM3v2_0.get_moneyLeft());
    assertEquals(State.STANDARDAMOUNTSELECTION, aTM3v2_0.get_atmState());
    assertEquals(0, aTM3v2_0.get_numOfBalanceChecks());

    aTM3v2_0.set_insertMoneySizeStandard(100);
    aTM3v2_0.step();
    assertEquals(900, aTM3v2_0.get_moneyLeft());
    assertEquals(State.AWAITCARD, aTM3v2_0.get_atmState());
    assertEquals(0, aTM3v2_0.get_numOfBalanceChecks());
