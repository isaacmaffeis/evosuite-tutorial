...
class EnumTD_ATG {
	...
	*/
	...
	/**
	* Get the monitored function {@code enumtoenumMonitoredFunction_fromDomain_STATE1}.
	*
	* @return the selected {@code EnumTD.EnumDomain enumtoenumMonitoredFunction_fromDomain_STATE1} enumtoenumMonitoredFunction_fromDomain_STATE1
	*/
	private EnumTD.EnumDomain get_enumtoenumMonitoredFunction_fromDomain_STATE1() {
		return this.execution.enumtoenumMonitoredFunction.get(this.execution.EnumDomain_elemsList.get(0));
	}

	/**
	* Get the monitored function {@code enumtoenumMonitoredFunction_fromDomain_STATE2}.
	*
	* @return the selected {@code EnumTD.EnumDomain enumtoenumMonitoredFunction_fromDomain_STATE2} enumtoenumMonitoredFunction_fromDomain_STATE2
	*/
	private EnumTD.EnumDomain get_enumtoenumMonitoredFunction_fromDomain_STATE2() {
		return this.execution.enumtoenumMonitoredFunction.get(this.execution.EnumDomain_elemsList.get(1));
	}

	/**
	* Get the monitored function {@code enumtoenumMonitoredFunction_fromDomain_STATE3}.
	*
	* @return the selected {@code EnumTD.EnumDomain enumtoenumMonitoredFunction_fromDomain_STATE3} enumtoenumMonitoredFunction_fromDomain_STATE3
	*/
	private EnumTD.EnumDomain get_enumtoenumMonitoredFunction_fromDomain_STATE3() {
		return this.execution.enumtoenumMonitoredFunction.get(this.execution.EnumDomain_elemsList.get(2));
	}

	/**
	* Get the monitored function {@code anotherEnumtoenumMonitoredFunction_fromDomain_ON}.
	*
	* @return the selected {@code EnumTD.EnumDomain anotherEnumtoenumMonitoredFunction_fromDomain_ON} anotherEnumtoenumMonitoredFunction_fromDomain_ON
	*/
	private EnumTD.EnumDomain get_anotherEnumtoenumMonitoredFunction_fromDomain_ON() {
		return this.execution.anotherEnumtoenumMonitoredFunction.get(this.execution.AnotherEnumDomain_elemsList.get(0));
	}

	/**
	* Get the monitored function {@code anotherEnumtoenumMonitoredFunction_fromDomain_OFF}.
	*
	* @return the selected {@code EnumTD.EnumDomain anotherEnumtoenumMonitoredFunction_fromDomain_OFF} anotherEnumtoenumMonitoredFunction_fromDomain_OFF
	*/
	private EnumTD.EnumDomain get_anotherEnumtoenumMonitoredFunction_fromDomain_OFF() {
	...
	*/
	private void coverOutputs() {
		...
		cover_enumtoenumMonitoredFunction_fromDomain_STATE1();
		cover_enumtoenumMonitoredFunction_fromDomain_STATE2();
		cover_enumtoenumMonitoredFunction_fromDomain_STATE3();
		cover_anotherEnumtoenumMonitoredFunction_fromDomain_ON();
		cover_anotherEnumtoenumMonitoredFunction_fromDomain_OFF();
		cover_enumControlledFunction();
		cover_anotherEnumControlledFunction();
		cover_enumtoenumControlledFunction_fromDomain_STATE1();
		cover_enumtoenumControlledFunction_fromDomain_STATE2();
		cover_enumtoenumControlledFunction_fromDomain_STATE3();
		cover_anotherEnumtoenumControlledFunction_fromDomain_STATE1();
		cover_anotherEnumtoenumControlledFunction_fromDomain_STATE2();
		cover_anotherEnumtoenumControlledFunction_fromDomain_STATE3();
	}
	...
	private void cover_enumtoenumMonitoredFunction_fromDomain_STATE1() {
		if (this.get_enumtoenumMonitoredFunction_fromDomain_STATE1() == null) {
			return;
		}
		switch (this.get_enumtoenumMonitoredFunction_fromDomain_STATE1()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_enumtoenumMonitoredFunction_fromDomain_STATE2() {
		if (this.get_enumtoenumMonitoredFunction_fromDomain_STATE2() == null) {
			return;
		}
		switch (this.get_enumtoenumMonitoredFunction_fromDomain_STATE2()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_enumtoenumMonitoredFunction_fromDomain_STATE3() {
		if (this.get_enumtoenumMonitoredFunction_fromDomain_STATE3() == null) {
			return;
		}
		switch (this.get_enumtoenumMonitoredFunction_fromDomain_STATE3()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_anotherEnumtoenumMonitoredFunction_fromDomain_ON() {
		if (this.get_anotherEnumtoenumMonitoredFunction_fromDomain_ON() == null) {
			return;
		}
		switch (this.get_anotherEnumtoenumMonitoredFunction_fromDomain_ON()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_anotherEnumtoenumMonitoredFunction_fromDomain_OFF() {
		if (this.get_anotherEnumtoenumMonitoredFunction_fromDomain_OFF() == null) {
			return;
		}
		switch (this.get_anotherEnumtoenumMonitoredFunction_fromDomain_OFF()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_enumtoenumControlledFunction_fromDomain_STATE1() {
		if (this.get_enumtoenumControlledFunction_fromDomain_STATE1() == null) {
			return;
		}
		switch (this.get_enumtoenumControlledFunction_fromDomain_STATE1()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_enumtoenumControlledFunction_fromDomain_STATE2() {
		if (this.get_enumtoenumControlledFunction_fromDomain_STATE2() == null) {
			return;
		}
		switch (this.get_enumtoenumControlledFunction_fromDomain_STATE2()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_enumtoenumControlledFunction_fromDomain_STATE3() {
		if (this.get_enumtoenumControlledFunction_fromDomain_STATE3() == null) {
			return;
		}
		switch (this.get_enumtoenumControlledFunction_fromDomain_STATE3()) {
		case STATE1:
			System.out.println("Branch EnumDomain STATE1 covered");
			break;
		case STATE2:
	...
	private void cover_anotherEnumtoenumControlledFunction_fromDomain_STATE1() {
		if (this.get_anotherEnumtoenumControlledFunction_fromDomain_STATE1() == null) {
			return;
		}
		switch (this.get_anotherEnumtoenumControlledFunction_fromDomain_STATE1()) {
		case ON:
			System.out.println("Branch AnotherEnumDomain ON covered");
			break;
		case OFF:
	...
	private void cover_anotherEnumtoenumControlledFunction_fromDomain_STATE2() {
		if (this.get_anotherEnumtoenumControlledFunction_fromDomain_STATE2() == null) {
			return;
		}
		switch (this.get_anotherEnumtoenumControlledFunction_fromDomain_STATE2()) {
		case ON:
			System.out.println("Branch AnotherEnumDomain ON covered");
			break;
		case OFF:
	...
	private void cover_anotherEnumtoenumControlledFunction_fromDomain_STATE3() {
		if (this.get_anotherEnumtoenumControlledFunction_fromDomain_STATE3() == null) {
			return;
		}
		switch (this.get_anotherEnumtoenumControlledFunction_fromDomain_STATE3()) {
		case ON:
			System.out.println("Branch AnotherEnumDomain ON covered");
			break;
		case OFF:
	...
	public void set_enumtoconcreteMonitoredFunction_fromDomain_STATE1(int enumtoconcreteMonitoredFunction_STATE1) {
	...
	public void set_enumtoconcreteMonitoredFunction_fromDomain_STATE2(int enumtoconcreteMonitoredFunction_STATE2) {
	...
	public void set_enumtoconcreteMonitoredFunction_fromDomain_STATE3(int enumtoconcreteMonitoredFunction_STATE3) {
