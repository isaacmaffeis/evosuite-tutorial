...
public class coffeeVendingMachineNC extends coffeeVendingMachineNCSig {
	
	// Inizializzazione di funzioni e domini
	
	public coffeeVendingMachineNC(){
	...
	void r_serveProduct_seq (Product _p){
		//{ //par
			QuantityDomain QuantityDomain811301908_s = new QuantityDomain();
			QuantityDomain811301908_s.value = (//available.get(_p).value
			(available.get(_p)
			.value - 1));
							   available.set(_p, QuantityDomain811301908_s);
			CoinDomain CoinDomain1762902523_s = new CoinDomain();
			CoinDomain1762902523_s.value = (//coins.get().value
			(coins.get()
			.value + 1));
							   coins.set(CoinDomain1762902523_s);
		//} //endpar
	}
