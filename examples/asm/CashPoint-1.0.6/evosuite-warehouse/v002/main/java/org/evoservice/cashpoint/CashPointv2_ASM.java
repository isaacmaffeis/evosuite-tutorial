...
// CashPointv2_ASM.java automatically generated from ASM2CODE
 ...
 * </p>
 */
class CashPointv2_ASM {

	private final CashPointv2 esecuzione;
	private int stato;

	/**
	 * Constructor of the {@code CashPointv2_ASM} class. Creates a private instance of the asm
	 * {@link CashPointv2} and sets the initial state of the state machine to 1.
	 */
	public CashPointv2_ASM(){
		this.esecuzione = new CashPointv2();
		this.stato = 0;
	}
	...
	private CashPointv2.Date get_currentDate(){
		return this.esecuzione.currentDate.get();
	}

	// Controlled getters

	public CashPointv2.TillState get_tillState_till1(){
...
/*
	public CashPointv2.Card get_insertedCard_till1(){
		return this.esecuzione.insertedCard.oldValues.get(
				this.esecuzione.Till_Class.get(
						this.esecuzione.Till_elemsList.indexOf("till1")));
	}

	public String get_cardLastUseDate_card1(){
		return this.esecuzione.cardLastUseDate.oldValues.get(
				this.esecuzione.Card_Class.get(
						this.esecuzione.Card_elemsList.indexOf("card1"))).toString();
	}

	public String get_cardLastUseDate_card2(){
		return this.esecuzione.cardLastUseDate.oldValues.get(
				this.esecuzione.Card_Class.get(
						this.esecuzione.Card_elemsList.indexOf("card2"))).toString();
	}
*/
	// Cover functions
