...
// TrafficLightv2_ASM.java automatically generated from ASM2CODE
...
* </p>
*/
class TrafficLightv2_ASM {
	
	private final TrafficLightv2 esecuzione;
	private int stato;
	
    /**
     * Constructor of the {@code TrafficLightv2_ASM} class. Creates a private instance of the asm
     * {@link TrafficLightv2} and sets the initial state of the state machine to 1.
     */
	public TrafficLightv2_ASM(){
		this.esecuzione = new TrafficLightv2();
		this.stato = 0;
	}
