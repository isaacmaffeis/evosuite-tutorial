...
class EnumTD {
	...
	//Funzione di tipo monitored
	FunN<EnumDomain, Character> enumtocharMonitoredFunction = new FunN<>();
	//Funzione di tipo monitored
	FunN<EnumDomain, Double> enumtorealMonitoredFunction = new FunN<>();
	//Funzione di tipo monitored
	...
	//Funzione di tipo Controlled
	FunNCtrl<EnumDomain, Character> enumtocharControlledFunction = new FunNCtrl<>();
	//Funzione di tipo Controlled
	FunNCtrl<EnumDomain, Double> enumtorealControlledFunction = new FunNCtrl<>();
	//Funzione di tipo Controlled
	...
	EnumTD() {
		...
		for (EnumDomain _c : EnumDomain.values()) {
			Integer a = null;
			if (EnumDomain_elem.value.equals(EnumDomain.STATE1))
				a = 10;
			else if (EnumDomain_elem.value.equals(EnumDomain.STATE2))
				a = 20;
			else if (EnumDomain_elem.value.equals(EnumDomain.STATE3))
				a = 30;
			;
		...
		for (EnumDomain _c : EnumDomain.values()) {
			...
			a.value = 'd';
			enumtocharControlledFunction.oldValues.put(_c, a);
			enumtocharControlledFunction.newValues.put(_c, a);
		}
		for (EnumDomain _c : EnumDomain.values()) {
			Double a = null;
			if (EnumDomain_elem.value.equals(EnumDomain.STATE1))
				...
				a = 9.2;
			;
			enumtorealControlledFunction.oldValues.put(_c, a);
			enumtorealControlledFunction.newValues.put(_c, a);
		}
		for (EnumDomain _c : EnumDomain.values()) {
	...
	void fireUpdateSet() {
		...
		enumtocharControlledFunction.oldValues = enumtocharControlledFunction.newValues;
		enumtorealControlledFunction.oldValues = enumtorealControlledFunction.newValues;
