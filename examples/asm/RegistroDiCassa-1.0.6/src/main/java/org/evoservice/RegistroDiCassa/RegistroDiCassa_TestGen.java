...
class RegistroDiCassa_TestGen{

	abstract static class RegistroDiCassav4Sig {
		/////////////////////////////////////////////////
		/// DOMAIN CONTAINERS
		/////////////////////////////////////////////////
	...
	static class RegistroDiCassav4 extends RegistroDiCassav4Sig {
		// Inizializzazione di funzioni e domini
		private RegistroDiCassav4() {
	...
	private final RegistroDiCassav4 registroDiCassav4;

	public RegistroDiCassa_TestGen() {
		registroDiCassav4 = new RegistroDiCassav4();
	}

	public void step() {
		registroDiCassav4.step();
	}

	// Controlled getters
	public RegistroDiCassav4Sig.Pizza get_pizzaCorrente() {
		return registroDiCassav4.get_pizzaCorrente();
	}

	public RegistroDiCassav4Sig.Stati get_statoCassa() {
		return registroDiCassav4.get_statoCassa();
	}

	public String get_outMess() {
		return registroDiCassav4.get_outMess();
	}

	public int get_totale() {
		return registroDiCassav4.get_totale();
	}

	// Monitored Setters
	public void set_servizioSelezionato(RegistroDiCassav4Sig.Servizio servizioSelezionato){
		registroDiCassav4.set_servizioSelezionato(servizioSelezionato);
	}

	public void set_pizzaInserita(String pizzaInserita){
		registroDiCassav4.set_pizzaInserita(pizzaInserita);
	}

	public void set_sceltaDiAggiuntaPizza(RegistroDiCassav4Sig.AggiungiPizza sceltaDiAggiuntaPizza){
		registroDiCassav4.set_sceltaDiAggiuntaPizza(sceltaDiAggiuntaPizza);
	}

	public void set_sceltaDelTipoDiPizza(RegistroDiCassav4Sig.SelezioneTipoDiPizza sceltaDelTipoPizza){
		registroDiCassav4.set_sceltaDelTipoDiPizza(sceltaDelTipoPizza);
	}

	public void set_insertQuantita(int insertQuantita){
		registroDiCassav4.set_insertQuantita(insertQuantita);
	}

	public void set_insertPrezzo(int insertPrezzo){
		registroDiCassav4.set_insertPrezzo(insertPrezzo);
	}
